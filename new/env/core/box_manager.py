...
class BoxManager:
    ...
    def is_node_drop_available(self, node: str) -> bool:
        """True se o nó pode receber uma caixa (máx. 1 por nó)."""
    ...
    def on_pick(self, robot_id: str, box_id: int, robot_node: str) -> float:
    ...
    def on_drop(self, box_id: int, node: str) -> tuple[float, bool]:
