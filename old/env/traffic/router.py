...
from old.env.traffic.astar import plan
from old.env.traffic.locks import NodeLock, ParkingLock, SegmentLock
from old.env.traffic.prediction import (
    LOOKAHEAD_STEPS,
...
class Router:
        ...
        for other in robots:
            ...
            if (
                ...
                try:
                    ...
                    from old.env.core.physics import MAX_SPEED
    ...
    def _ticks_remaining(self, robot: Robot) -> int:
        ...
        try:
            ...
            from old.env.core.physics import MAX_SPEED, SHORTEST_EDGE
